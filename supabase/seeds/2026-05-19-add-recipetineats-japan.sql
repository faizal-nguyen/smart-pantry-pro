...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    -- Viande
    (v_recipe_id, 'bœuf haché',                 200,  'g',          true,  9,  'ou boeuf/poulet/mix'),
    ...
    (v_recipe_id, 'bouillon dashi de cuisine',            15,   'ml',         true,  13, NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'bouillon dashi de cuisine',             15,  'ml',         true,  3,  'marinade'),
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',                       2.5, 'ml',         true,  4,  'marinade'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'graisse de boeuf fin',                     360,  'g',          true,  6,  'tranches longueur 7 cm'),
    -- Sauce tare
    (v_recipe_id, 'sauce soja',                   185,  'ml',         true,  7,  'pour la tare'),
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',                        185,  'ml',         true,  8,  'pour la tare'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    -- Galette
    (v_recipe_id, 'boeuf hache',               500,  'g',          true,  3,  NULL),
    ...
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',                    30,   'ml',         true,  12, 'teriyaki'),
    (v_recipe_id, 'bouillon dashi de cuisine',          30,   'ml',         true,  13, 'teriyaki'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    -- Sauce
    (v_recipe_id, 'bouillon dashi de cuisine',            1,   'c. à soupe', true,  6,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'boeuf hache',                 200, 'g',          true,  3,  'ou mix boeuf-bœuf'),
    ...
    (v_recipe_id, 'bouillon dashi de cuisine',            1,   'c. à soupe', true,  8,  NULL),
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',                      1,   'c. à soupe', true,  9,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',                    105, 'ml',         true,  5,  NULL),
