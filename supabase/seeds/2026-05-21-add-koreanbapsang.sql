...
$instr$, 15, 10, 4, 2, 'Coréenne', 'lunch',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',1,'c. à soupe',true,9,'sauce'),
...
$instr$, 90, 20, 4, 3, 'Coréenne', 'snack',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon leger et vinaigre de riz',1,'c. à soupe',true,7,NULL),
    ...
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',45,'ml',true,11,'sauce'),
...
$instr$, 10, 12, 3, 2, 'Coréenne', 'snack',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'boeuf hache ou thon',85,'g',false,4,'optionnel'),
...
$instr$, 25, 20, 4, 3, 'Coréenne', 'dinner',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon leger et vinaigre de riz',2,'c. à soupe',true,10,'ou vinaigre de riz, sucre et eau (3:1:3)'),
...
$instr$, 25, 30, 4, 3, 'Coréenne', 'dinner',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon leger',10,'ml',true,6,NULL),
...
$instr$, 10, 25, 2, 2, 'Coréenne', 'dinner',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'boeuf gras',120,'g',true,2,'ou boeuf gras'),
...
$instr$, 10, 10, 4, 2, 'Coréenne', 'snack',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon leger et vinaigre de riz',30,'ml',true,9,'ou vinaigre de riz, sucre et eau (3:1:3)');
...
$instr$, 10, 15, 4, 2, 'Coréenne', 'lunch',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon leger et vinaigre de riz',15,'ml',true,8,'ou vinaigre de riz, sucre et eau (3:1:3)'),
