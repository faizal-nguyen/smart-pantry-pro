...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      3,   'c. à soupe', true,  7,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 250, 'g',          true,  1,  'ou autre viande hachée'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'jambon',                     3,   'tranche',    true,  12, 'en lanières');
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       5,   'ml',         true,  6,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  3,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       30,  'ml',         true,  6,  NULL),
    (v_recipe_id, 'mirin',                      30,  'ml',         true,  7,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 170, 'g',          true,  2,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  3,  NULL),
    (v_recipe_id, 'mirin',                      1,   'c. à soupe', true,  4,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      3,   'c. à soupe', true,  5,  'pour la sauce'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  7,  'pour cuisson vapeur'),
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  8,  'pour la sauce'),
    (v_recipe_id, 'mirin',                      1,   'c. à soupe', true,  9,  'pour la sauce'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 120, 'g',          true,  2,  'ou autre viande'),
    ...
    (v_recipe_id, 'mirin',                      15,  'ml',         true,  11, NULL),
