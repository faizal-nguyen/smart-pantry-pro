...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'jarrets de porc',            900, 'g',          true,  3,  'en morceaux'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'bière',                      2,   'c. à soupe', false, 5,  'optionnelle, sinon eau'),
    ...
    (v_recipe_id, 'épaule de porc',             340, 'g',          true,  10, 'tranchée fin'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 250, 'g',          true,  1,  'garniture principale'),
