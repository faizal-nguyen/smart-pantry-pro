...
$instr$, 10, 10, 1, 3, 'Japonaise', 'lunch',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'bouillon dashi',0.5,'c. à soupe',true,2,NULL),
    ...
    (v_recipe_id, 'vinaigre de riz, sucre et eau (3:1:3)',1,'c. à soupe',true,10,NULL),
    (v_recipe_id, 'bouillon dashi',1,'c. à soupe',true,11,NULL),
