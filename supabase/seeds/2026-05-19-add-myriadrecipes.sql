...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'chorizo',                   150, 'g',          true,  5,  'finement haché'),
    (v_recipe_id, 'persil',                    10,  'g',          true,  6,  'haché'),
    (v_recipe_id, 'mozzarella',                125, 'g',          true,  7,  'grossièrement coupée'),
    (v_recipe_id, 'pâte de nduja',             1,   'c. à soupe', true,  8,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'chorizo',                   60,  'g',          true,  4,  'grossièrement tranché'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                250, 'g',          true,  5,  NULL),
    (v_recipe_id, 'vin de Shaoxing',           1,   'c. à café',  false, 6,  'ou vinaigre de riz'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'tranches de bacon',         8,   'unité',      true,  11, NULL),
