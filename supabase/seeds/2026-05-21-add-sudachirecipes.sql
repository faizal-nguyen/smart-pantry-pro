...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      3,   'c. à soupe', true,  2,  NULL),
    (v_recipe_id, 'saké',                       3,   'c. à soupe', true,  3,  'ou xérès sec'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 300, 'g',          true,  1,  '20% de matière grasse'),
    (v_recipe_id, 'miso blanc',                 1,   'c. à café',  true,  2,  'umami caché'),
    (v_recipe_id, 'panko',                      1,   'c. à soupe', true,  3,  'panade'),
    (v_recipe_id, 'saké',                       2,   'c. à soupe', true,  4,  'pour la panade'),
    ...
    (v_recipe_id, 'mirin',                      1.5, 'c. à soupe', true,  10, 'teriyaki'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      3,   'c. à soupe', true,  12, NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  3,  'ou vin blanc sec'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'saké',                       0.5, 'c. à soupe', true,  4,  'marinade'),
    ...
    (v_recipe_id, 'saké',                       1,   'c. à soupe', true,  15, 'sauce'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'porc haché',                 100, 'g',          true,  1,  'ou mélange 50/50'),
    ...
    (v_recipe_id, 'saké',                       1.5, 'c. à soupe', true,  14, NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      1.5, 'c. à soupe', true,  6,  NULL),
    (v_recipe_id, 'saké',                       1.5, 'c. à soupe', true,  7,  NULL),
