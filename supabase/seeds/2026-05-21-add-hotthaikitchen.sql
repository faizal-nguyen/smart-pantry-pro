...
$instr$, 15, 20, 2, 2, 'Thaïlandaise', 'lunch',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'boeuf hache',100,'g',true,7,NULL),
    (v_recipe_id, 'sauce de poisson',1,'c. à café',true,8,'pour cuire boeuf'),
...
$instr$, 40, 5, 2, 3, 'Thaïlandaise', 'dinner',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    ...
    (v_recipe_id, 'filet de boeuf',300,'g',true,2,'tranché fin contre le grain'),
...
$instr$, 20, 20, 4, 3, 'Thaïlandaise', 'dinner',
  ...
  INSERT INTO public.recipe_ingredients (recipe_id, ingredient_name, quantity, unit, is_essential, order_index, notes) VALUES
    (v_recipe_id, 'épaule de boeuf',340,'g',true,1,'tranchée fin'),
    ...
    (v_recipe_id, 'bouillon de boeuf',720,'ml',true,14,'non salé'),
