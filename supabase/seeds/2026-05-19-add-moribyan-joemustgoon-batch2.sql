...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'SPAM',                       1,   'unité',      true,  12, 'une boîte, en cubes'),
    ...
    (v_recipe_id, 'sake',                       2,   'c. à soupe', true,  17, NULL),
    (v_recipe_id, 'mirin',                      80,  'ml',         true,  18, '1/4 cup + 1.5 tbsp'),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'mirin',                      4,   'c. à soupe', true,  7,  NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'vin blanc',                  60,  'ml',         true,  15, NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'vin rouge',                  120, 'ml',         true,  14, NULL),
...
$instr$,
  ...
  INSERT INTO public.recipe_ingredients (
    ...
    (v_recipe_id, 'sherry',                     0.5, 'c. à soupe', true,  17, NULL),
    (v_recipe_id, 'bacon',                      350, 'g',          true,  18, 'un paquet'),
